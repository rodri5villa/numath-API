...
const Secante = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/ecuacion/secante', {
        funcion,
        p0,
        p1,
        ...(TOL && { TOL }),
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
                El <strong>método de la secante</strong> es un método numérico para encontrar una solución aproximada 
                a la ecuación <code className="bg-gray-200 px-1 rounded">f(x)=0</code> sin requerir el cálculo explícito de la derivada. En lugar de usar 
                la derivada, utiliza dos aproximaciones iniciales y calcula la siguiente aproximación mediante 
                la recta secante que une los puntos (<code className="bg-gray-200 px-1 rounded">p0</code>, <code className="bg-gray-200 px-1 rounded">f(p0)</code>) 
                y (<code className="bg-gray-200 px-1 rounded">p1</code>, <code className="bg-gray-200 px-1 rounded">f(p1)</code>).
            </p>
