...
const NewtonCotesN3Cerrado = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n3_cerrado', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de Newton-Cotes cerrado de orden 3</strong>, también conocido como la
              <strong> regla de Simpson 3/8</strong>, aproxima la integral definida de una función mediante
              interpolación cúbica en cuatro puntos equiespaciados del intervalo <code className="bg-gray-200 px-1 rounded">[a, b]</code>, 
              donde <code className="bg-gray-200 px-1 rounded">x0 = a</code>, <code className="bg-gray-200 px-1 rounded">x1 = a+h</code>, 
              <code className="bg-gray-200 px-1 rounded">x2 = a+2*h</code> y <code className="bg-gray-200 px-1 rounded">x3 = b</code>.
            </p>
...
export default NewtonCotesN3Cerrado;
