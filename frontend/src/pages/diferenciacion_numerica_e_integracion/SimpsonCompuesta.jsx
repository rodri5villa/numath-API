...
const SimpsonCompuesta = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/regla_simpson_compuesta', {
        funcion,
        a,
        b,
        n,
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
                La <strong>regla de Simpson compuesta</strong> aproxima la integral de una función <code className="bg-gray-200 px-1 rounded">f(x)</code> 
                usando <strong>párabolas</strong> (polinomios de segundo grado). Divide el intervalo <code className="bg-gray-200 px-1 rounded">[a,b]</code>
                en un número par de subintervalos y aplica la <strong>fórmula de Simpson</strong> en cada par de intervalos.
          </p>
...
export default SimpsonCompuesta;
