...
const NewtonCotesN3Abierto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n3_abierto', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de Newton-Cotes abierto de orden 3</strong> utiliza cuatro puntos internos en el intervalo 
              <code className="bg-gray-200 px-1 rounded">[a, b]</code>, excluyendo los extremos.
            </p>
...
export default NewtonCotesN3Abierto;
