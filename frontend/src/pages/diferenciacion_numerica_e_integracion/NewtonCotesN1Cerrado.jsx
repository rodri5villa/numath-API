...
const NewtonCotesN1Cerrado = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n1_cerrado', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de Newton-Cotes cerrado de orden 1</strong>, también conocido como
              <strong> regla del trapecio</strong>, aproxima la integral definida de una función utilizando
              un polinomio de grado 1 que pasa por los puntos extremos del intervalo <code className="bg-gray-200 px-1 rounded">[a, b]</code>.
            </p>
...
export default NewtonCotesN1Cerrado;
