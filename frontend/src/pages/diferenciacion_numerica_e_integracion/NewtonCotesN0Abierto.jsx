...
const NewtonCotesN0Abierto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n0_abierto', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de Newton-Cotes abierto de orden 0</strong>, también conocido como
              <strong> regla del punto medio</strong>, aproxima la integral de la función mediante la evaluación en el punto medio del intervalo, 
              dado un intervalo <code className="bg-gray-200 px-1 rounded">[a, b]</code>. 
            </p>
...
export default NewtonCotesN0Abierto;
