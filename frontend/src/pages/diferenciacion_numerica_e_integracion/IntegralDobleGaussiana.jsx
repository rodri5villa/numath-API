...
const IntegralDobleGaussiana = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/integral_doble_gaussiana', {
        funcion,
        a,
        b,
        c_func: c,
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de la integral doble gaussiana</strong> aproxima la integral doble usando <strong>cuadratura de Gauss–Legendre</strong> de orden 
              <code className="bg-gray-200 px-1 rounded">m</code> en <code className="bg-gray-200 px-1 rounded">x</code> y 
              de orden <code className="bg-gray-200 px-1 rounded">n</code> en <code className="bg-gray-200 px-1 rounded">y</code>.
            </p>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md space-y-6">
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <label className="block mb-1 font-semibold">m (nodos en x):</label>
                <input
                  type="text"
                  value={m}
              ...
              <div className="flex-1">
                <label className="block mb-1 font-semibold">n (nodos en y):</label>
                <input
                  type="text"
                  value={n}
...
export default IntegralDobleGaussiana;