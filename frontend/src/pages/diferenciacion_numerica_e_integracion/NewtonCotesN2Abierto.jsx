...
const NewtonCotesN2Abierto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n2_abierto', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
                El <strong>método de Newton-Cotes abierto de orden 2</strong> utiliza tres puntos dentro del intervalo 
                <code className="bg-gray-200 px-1 rounded">(a, b)</code>, ignorando los extremos, para estimar el valor de la integral. 
            </p>
...
export default NewtonCotesN2Abierto;