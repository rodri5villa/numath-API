...
const NewtonCotesN2Cerrado = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!funcion.trim() || !a.trim() || !b.trim()) {
      setError('Por favor, completa la función y los límites de integración a y b.');
      setResultado(null);
      return;
    }

    try {
      const res = await axios.post('http://localhost:5000/calculo/newton_cotes_n2_cerrado', {
        funcion,
        a,
        b,
      });
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de Newton-Cotes cerrado de orden 2</strong>, también conocido como la
              <strong> regla del Simpson 1/3</strong>, aproxima la integral definida de una función utilizando
              un polinomio de segundo grado que interpola tres puntos del intervalo <code className="bg-gray-200 px-1 rounded">[a, b]</code>, donde <code className="bg-gray-200 px-1 rounded">x0 = a</code>, 
              <code className="bg-gray-200 px-1 rounded">x1 = a+h</code> y <code className="bg-gray-200 px-1 rounded">x2 = b</code>.
            </p>
        ...
        {resultado && resultado !== 'calculando' && (
          <div className="bg-green-100 border border-green-400 text-green-700 p-6 rounded-lg space-y-2">
            ...
            <p><strong>Valor aproximado de la integral:</strong> {resultado.resultado || resultado}</p>
          </div>
        )}
...
export default NewtonCotesN2Cerrado;
