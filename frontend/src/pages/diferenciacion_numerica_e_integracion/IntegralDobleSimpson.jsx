...
const IntegralDobleSimpson = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const res = await axios.post('http://localhost:5000/calculo/integral_doble_simpson', {
            funcion,
            a,
            b,
            c_func: c,
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              El <strong>método de la integral doble de Simpson</strong> aproxima la integral de una función <code className="bg-gray-200 px-1 rounded">f(x,y)</code> 
              usando la regla compuesta de Simpson primero en <code className="bg-gray-200 px-1 rounded">y</code> 
              (para cada <code className="bg-gray-200 px-1 rounded">xi</code>) y luego en <code className="bg-gray-200 px-1 rounded">x</code>.
            </p>

            <p className="text-2xl font-bold">¿Cómo introducir la función y los parámetros?</p>
             
            <p>
                Usa la variable <code className="bg-gray-200 px-1 rounded">x</code> e <code className="bg-gray-200 px-1 rounded">y</code> para definir la función.                     
        ...
        <div className="bg-blue-50 border border-blue-300 rounded-md p-4 space-y-2">
            ...
            <ul className="list-disc ml-6 space-y-1 text-blue-700">
                <li><code className="bg-gray-100 px-1 rounded">4x^2 - y^4</code></li>
                <li><code className="bg-gray-100 px-1 rounded">3sin(xy) - 0.5</code></li>
                <li><code className="bg-gray-100 px-1 rounded">exp(x) - 2</code></li>
                <li><code className="bg-gray-100 px-1 rounded">sqrt(2x) - 3y</code></li>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md space-y-6">
          <div className="space-y-4">
            <div>
              <label className="block mb-1 font-semibold">Función f(x, y):</label>
              <input
                type="text"
                value={funcion}
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <label className="block mb-1 font-semibold">n (subintervalos en x):</label>
                <input
                  type="text"
                  value={n}
                  onChange={manejarCambio(setN, 'n')}
                  placeholder="Ej: 4"
                  className="w-full border border-gray-300 rounded-md p-2"
                  required
                />
              ...
              <div className="flex-1">
                <label className="block mb-1 font-semibold">m (subintervalos en y):</label>
                <input
                  type="text"
                  value={m}
                  onChange={manejarCambio(setM, 'm')}
                  placeholder="Ej: 4"
                  className="w-full border border-gray-300 rounded-md p-2"
                  required
                />
        ...
        {resultado && resultado !== 'calculando' && (
          <div className="bg-green-100 border border-green-400 text-green-700 p-6 rounded-lg space-y-2">
            ...
            <p><strong>Valor de la integral doble:</strong> {resultado.resultado}</p>
          </div>
        )}
...
export default IntegralDobleSimpson;
