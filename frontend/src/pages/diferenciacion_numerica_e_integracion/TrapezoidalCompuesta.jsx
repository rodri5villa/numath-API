...
const TrapezoidalCompuesta = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/calculo/regla_trapezoidal_compuesta', {
        funcion,
        a,
        b,
        n
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-gray-700 space-y-5 text-base">
          <div className="space-y-3">
            <p>
              La <strong>regla trapezoidal compuesta</strong> aproxima la integral de una función <code className="bg-gray-200 px-1 rounded">f(x)</code> 
              usando <strong>segmentos de línea recta</strong> entre los puntos. Divide el intervalo <code className="bg-gray-200 px-1 rounded">[a,b]</code> en 
              <code className="bg-gray-200 px-1 rounded">n</code> subintervalos y usa la <strong>fórmula del trapecio</strong> en cada uno, sumando luego los resultados.
            </p>
...
export default TrapezoidalCompuesta;
